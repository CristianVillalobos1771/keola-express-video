 ...
 *
 * Each scene manages its own fade-in/fade-out internally via its
 * sceneOpacity variable, so overlapping Sequences create smooth crossfades.
 */

const FADE = 15;

// Scene start / end (absolute)
const S1 = 0;
const S2 = 90;
const S3 = 210;
const S4 = 570;
...
export const ExpressVideo: React.FC = () => {
  return (
    <AbsoluteFill style={{ background: "radial-gradient(ellipse 80% 70% at 50% 50%, #CC8800 0%, #7A4200 30%, #280E00 65%, #0A0300 100%)" }}>
